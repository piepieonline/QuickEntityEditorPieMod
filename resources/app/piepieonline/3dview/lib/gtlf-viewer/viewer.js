  ...
  const THREE_PATH = `https://cdn.rawgit.com/mrdoob/three.js/master`
  const DRACO_LOADER = new THREE.DRACOLoader( MANAGER ).setDecoderPath( `${THREE_PATH}/examples/js/libs/draco/gltf/` );
  // const KTX2_LOADER = new THREE.KTX2Loader( MANAGER ).setTranscoderPath( `${THREE_PATH}/examples/js/libs/basis/` );
